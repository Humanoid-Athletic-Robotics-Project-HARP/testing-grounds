...
from utils.isaaclab_extensions.isaaclab_mimic.isaaclab_mimic.motion_planners.motion_planner_base import MotionPlannerBase
...
class CuroboPlanner(MotionPlannerBase):
    ...
    def __init__(
        ...
        if self.visualize_plan:
            from utils.isaaclab_extensions.isaaclab_mimic.isaaclab_mimic.motion_planners.curobo.plan_visualizer import PlanVisualizer
