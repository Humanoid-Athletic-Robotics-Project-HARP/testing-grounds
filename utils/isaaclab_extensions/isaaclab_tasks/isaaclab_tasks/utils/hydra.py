...
try:
    import utils.isaaclab_extensions.isaaclab_tasks.isaaclab_tasks.utils.hydra as hydra
...
from utils.isaaclab_extensions.isaaclab_tasks.isaaclab_tasks.utils.parse_cfg import load_cfg_from_registry
