...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # robot (K1 22-DOF humanoid)
    robot = ArticulationCfg(
        prim_path="{ENV_REGEX_NS}/Robot",
        spawn=sim_utils.UsdFileCfg(
            usd_path=r"C:\Users\kylel\Humanoid\sim\K1_22dof\K1_22dof.usd",
        ),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Remove feet_body_forces for now (delete that ObsTerm)
...
class K1StandEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: MySceneCfg = MySceneCfg(num_envs=256, env_spacing=3.0, clone_in_fabric=True)
    # Basic settings
...
@configclass
class K1StandRslRlPpoCfg:
    seed: int = 42
    device: str = "cuda:0"
    experiment_name: str = "k1_stand"
    run_name: str = "k1_stand"
