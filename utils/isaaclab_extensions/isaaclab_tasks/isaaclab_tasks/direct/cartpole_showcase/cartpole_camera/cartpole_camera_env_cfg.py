...
from utils.isaaclab_extensions.isaaclab_tasks.isaaclab_tasks.direct.cartpole.cartpole_camera_env import CartpoleRGBCameraEnvCfg as CartpoleCameraEnvCfg
