...
if TYPE_CHECKING:
    from utils.isaaclab_extensions.isaaclab_tasks.isaaclab_tasks.direct.allegro_hand.allegro_hand_env_cfg import AllegroHandEnvCfg
    from utils.isaaclab_extensions.isaaclab_tasks.isaaclab_tasks.direct.shadow_hand.shadow_hand_env_cfg import ShadowHandEnvCfg
